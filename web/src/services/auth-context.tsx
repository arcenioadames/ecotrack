// ============================================================================
// AUTH CONTEXT - GESTION DE SESION Y AUTENTICACION
// ============================================================================
...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  // ========================================================================
  // INICIALIZACION - RESTAURAR SESION DEL STORAGE
  // ========================================================================
  ...
  useEffect(() => {
    ...
    const handleLogout = (event: Event) => {
      ...
      console.warn('Auth logout triggered:', customEvent.detail);
      logout();
    };
  ...
  const login = useCallback(async (input: LoginInput) => {
    ...
    try {
      ...
      // Obtener datos del usuario decodificando el JWT o haciendo una solicitud
      // Por simplicidad, decodificamos el JWT
      // Hacer solicitud a un endpoint que devuelva el usuario
      // Por ahora, asumimos que el user se obtiene después
